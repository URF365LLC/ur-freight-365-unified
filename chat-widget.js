(function () {
  ...
  async function askAssistant(question) {
    ...
    return data?.answer?.trim() || "I could not generate a response. Please call 346-522-2772 or email quote@yourfreight365llc.com.";
  }
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      console.error(error);
      const fallback = "Sorry, the UR Freight 365 assistant is having trouble connecting right now. For immediate help, call 346-522-2772 or email quote@yourfreight365llc.com.";
  ...
  widget.innerHTML = `
    <div class="urf-chat-panel" role="dialog" aria-modal="false" aria-labelledby="urf-chat-title">
      ...
      <p class="urf-chat-disclaimer">For confirmed quotes or urgent freight, call <a href="tel:3465222772">346-522-2772</a> or email quote@yourfreight365llc.com.</p>
    </div>
